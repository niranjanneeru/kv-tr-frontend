...
describe("Test for TextField Component", () => {
    ...
    it("Renders without errors", () => {
        render(<TextField textType="text" label="Username" placeHolder="Enter your username" value="john" isLogin={true} isLabelHidden={true} disabled={false} onChangeCallback={mockChangeCallback} />);
    });
    ...
    it("Changes input type when focused and blurred", () => {
        render(<TextField textType="password" label="Username" placeHolder="Enter your username" value="john" isLogin={true} isLabelHidden={true} disabled={false} onChangeCallback={mockChangeCallback} />);
